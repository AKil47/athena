...
class RelevancyEngine {
     ...
     * @param {string} visibleText - The visible text content of the page
     ...
     */
    async get_relevancy_score(usersgoal, url, title, visibleText, previousRelevancyScores) {
        ...
        <SystemPrompt>
            <Instruction>
                ...
                - **<VisibleText>**: The visible text content of the webpage.  
...
`
        ...
        const response = await query_single(
            "You are a helpful assistant.", 
            sysPrompt + "  Your input is as follows: " +
            "<UserGoal>" + usersgoal + "</UserGoal>" +
            "<URL>" + url + "</URL>" + 
            "<TabTitle>" + title + "</TabTitle>" +
            "<VisibleText>" + visibleText + "</VisibleText>" +
            "<PreviousRelevancyScore>" + previousRelevancyScores + "</PreviousRelevancyScore>"
        );
